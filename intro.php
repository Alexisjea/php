...
<body>
    ...
    switch($taille){
        ...
        case "XL" :
            echo "XL correspond à Xtra-large <br>";
        break;
    ...
    if ($taille == "XS" || $taille == "S"){
     ...
     echo "$taille ne coressepond pas à une taille standard <br>"; 
    }
    ...
    // EXO : Afficher les nombre de 1 à 10 en utilisant une boucle WHILE 
        $i =1 ;
        while ($i <= 10){  
            echo $i++ . " - ";
    ...
    <?php
    /* La boucle FOREACH s'utilise pour parcourir toutes les valeurs d'un tableau syntaxe :
        foreach($tableau as $valeur){}
    ou
        foreach($tableau as $indice => $valeur){}
    $tableau correspond à l'array que l'on veut parcourir
    ...
    $indice correspond à la variable qui vaudra chaque indice du tableau. Cela permet de savoir à quelle itération on se trouve
    ...
    */
    ...
    echo "<tr>
        ...
        echo "</table>";
        echo "<br>";
        // EXO : Affichez de la même façon , avec la variable $personnage
        ...
        echo "<tr><th colspan=2>Personnage</th></tr>
          ...
          foreach($personnage2 as $ind => $val){
          echo"<tr>";
          echo "<td>$ind</td>";
          echo "<td>$val</td>";
          echo "</tr>";
    ...
    <table>
        ...
        <tbody><?php  foreach($listePersonnages as  $personnage ):?>
    ...
    <h2>LES FONCTIONS </h2>
    <?php
                    /* Le but d'une fonction est d'écrire du code qui va pouvoir être rappelé au besoin à plusieurs endroits du code source.
                    Une fonction peur renvoyer une valeur avec le mot-clé 'return'
                    Une fonctionpeut utiliser des paramètres dont elle a besoin pour être éxécutée. Les valeurs de ces paramètres seront fournies lors de l'appel de cette fonction 
                    Dans l'exemple, la fonction nommée carre a un paramètre $nb. Cette fonction retourne $nb au carré */
                    ...
                    $a =5;
                    $resultat = carre($a);
                    echo "Le carre de $a est égal à $resultat <br>";

                    echo "Le carre de 9 est égal à " . carre(9) . "<br>";

                    // EXO : Affichez mes carrés de tous les nombres de 0 à 99 
                    /* ex: 1x1 =1
                           2x2 =4
                           3x3 =9*/
                   ...
                   for($i =0 ; $i <100; $i++){
                    ...
                    echo  $i . "x" . $i . "est égal à" . $resultat ."<br>";
